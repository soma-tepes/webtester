...
const LabelRastreComponentes = ({ dataLabel, datasForm, handlePrint, componentRefs, comparative , rastreSaveComponents}) => {
  ...
  useEffect(() => {
    if (Object.keys(rastreSaveComponents ?? {} )) {
      setQRCode([rastreSaveComponents?.[9],rastreSaveComponents?.[10],rastreSaveComponents?.[11]]
        .join(",").replace(/,/g, '')
        );
    }
...
<div onClick={handlePrint[18]}   ref={componentRefs[18]}> {
     <svg width="101.5mm" height="63.5mm" viewBox="0 0 101.5 63.5">
      <g>
        ...
        <text className='icTwo' x="25%" y="38%" >{rastreSaveComponents?.[2]}</text>


        <text className='icTwo' x="5%" y="45%" >Qty.</text>
        <text className='icTwo' x="29%" y="45%" >{rastreSaveComponents?.[4]}</text>
       
        <text className='icTwo' x="5%" y="52%" >Lot No.</text>
        <text className='icTwoo' x="29%" y="52%" >{rastreSaveComponents?.[7]}</text>
      
        <text className='icTwo' x="5%" y="59%" >W/O No.</text>
        <text className='icTwo' x="29%" y="59%" >{rastreSaveComponents?.[6]}</text>
        ...
        <text className='icTr' x="47%" y="95%" >{rastreSaveComponents?.[17]} </text>
   
        <text className='icTr' x="67%" y="95%" >{rastreSaveComponents?.[16]}</text>
