...
const LabelBasicEditable = ({ dataLabel, datasForm,handlePrint,componentRefs }) => {
  ...
  return (
    <div onClick={handlePrint[18]}   ref={componentRefs[18]}>
      ...
      <g>
        ...
        <text className='exa' x={`23%`} y="15%">{datasForm.line}</text>
        ...
        <text className='exa' x={`${dataLabel}`} y="39%">{datasForm.model}</text>
        ...
        <text className='ex' x={`57%`} y="75%">{datasForm.qty}</text>
